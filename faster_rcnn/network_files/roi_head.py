...
class RoIHeads(torch.nn.Module):
    ...
    def forward(self,
        ...
        """
        Arguments:
            features (List[Tensor]) 特征图
            proposals (List[Tensor[N, 4]]) 预测的proposal
            image_shapes (List[Tuple[H, W]]) 预处理后的图片尺寸
        ...
        # 将采集样本通过Multi-scale RoIAlign pooling层，将proposal变为7*7尺寸
